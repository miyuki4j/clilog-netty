package com.gow.clilog.netty.handler;
...
//                }
                ...
                LogCenter.getInstance().offerJson("HOME", json, hostAddress);

            }

            FullHttpResponse response = new DefaultFullHttpResponse(HTTP_1_1, OK, Unpooled.wrappedBuffer(new byte[]{'O', 'K'}));
